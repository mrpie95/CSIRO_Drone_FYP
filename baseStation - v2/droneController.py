...
class DroneController:
    ...
    def _connected(self, link_uri):
        ...
        #self.logBattery = LogConfig(name='battery', period_in_ms=10)
        
       #self._lg_stab.add_variable('stabilizer.roll', 'float')
        #self._lg_stab.add_variable('stabilizer.pitch', 'float')
        self._lg_stab.add_variable('stabilizer.yaw', 'float')
        #self.logBattery.add_variable('pm.vbat', 'float')
        
        try:
            self._cf.log.add_config(self._lg_stab)
         #   self._cf.log.add_config(self.logBattery)
            # This callback will receive the data
          #  self.logBattery.data_received_cb.add_callback(self.logBattery)
    ...
    def logBattery(self, timestamp, data, logconf):
        self.batterLvl = data['pm.vbat']
